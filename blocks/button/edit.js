  ...
  return (
    <>
      <InspectorControls>
        <PanelBody title={__('Button Settings', 'client-website')}>
          <SelectControl
            ...
            options={[
              ...
              { label: __('Tertiary', 'client-website'), value: 'tertiary' },
              { label: __('Danger', 'client-website'), value: 'danger' },
              { label: __('Success', 'client-website'), value: 'success' },
              { label: __('Outline', 'client-website'), value: 'outline' },
            ]}
            onChange={(value) => setAttributes({ variant: value })}
            help={__('Choose the button style', 'client-website')}
          />
          ...
          <SelectControl
            ...
            help={__('Choose the button size', 'client-website')}
          />
        ...
        <PanelBody title={__('Link Settings', 'client-website')} initialOpen={false}>
          <URLInput
      ...
      <div {...blockProps}>
        ...
        {!url && (
          <p className="button-block__help">
            {__('Add a URL in the sidebar settings', 'client-website')}
          </p>
        )}
      </div>
    </>
