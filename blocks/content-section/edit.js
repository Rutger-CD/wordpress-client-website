...
export default function Edit( { attributes, setAttributes } ) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={ __( 'Section Settings', 'client-website' ) }
					initialOpen={ true }
				>
					<SelectControl
						...
						options={ [
							{
								label: __( 'Contained', 'client-website' ),
								value: 'contained',
							},
							{
								label: __( 'Wide', 'client-website' ),
								value: 'wide',
							},
							{
								label: __( 'Full Width', 'client-website' ),
								value: 'full',
							},
						] }
						onChange={ ( value ) =>
