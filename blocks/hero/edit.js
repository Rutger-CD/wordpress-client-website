...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={__('Hero Settings', 'client-website')} initialOpen={true}>
					<SelectControl
						label={__('Variant', 'client-website')}
						value={variant}
						options={[
							{ label: __('Gradient', 'client-website'), value: 'gradient' },
							{ label: __('Solid', 'client-website'), value: 'solid' },
							{ label: __('Minimal', 'client-website'), value: 'minimal' },
						]}
				...
				<PanelBody title={__('Primary Button', 'client-website')} initialOpen={false}>
					<TextControl
				...
				<PanelBody title={__('Secondary Button', 'client-website')} initialOpen={false}>
					<TextControl
						label={__('Button Text', 'client-website')}
				...
				<div className="hero__container">
					<div className="hero__content">
						<RichText
							...
							placeholder={__('Enter subheading...', 'client-website')}
						/>
						<RichText
							tagName="h1"
						...
						<div className="hero__actions">
							{primaryButtonText && (
								<a href={primaryButtonUrl} className="btn btn--primary btn--large">
									{primaryButtonText}
								</a>
							)}
							{secondaryButtonText && (
								<a href={secondaryButtonUrl} className="btn btn--secondary btn--large">
									{secondaryButtonText}
								</a>
							)}
						</div>
